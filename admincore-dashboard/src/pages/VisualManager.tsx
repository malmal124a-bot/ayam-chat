  ...
  return (
    <div className="bg-[#141417] rounded-2xl border border-white/5 p-6 space-y-5">
      ...
      <div className="border-t border-white/5 pt-4">
        ...
        <div className="flex items-center gap-4">
          {(config as any).logoUrl ? (
            <div className="relative">
              <img src={(config as any).logoUrl} className="w-20 h-20 object-contain rounded-lg border border-white/5 bg-black/20"
                onError={e => { (e.target as HTMLImageElement).src = ''; }} />
        ...
        <input type="text" value={(config as any).logoUrl || ''}
