...
export default function LevelsPage() {
  ...
  const [form, setForm] = useState({
    title: '', minExp: 0, maxExp: 0, coins: 0, diamonds: 0, frame: '', badge: '', badgeUrl: '',
  ...
  const resetForm = () => setForm({ title: '', minExp: 0, maxExp: 0, coins: 0, diamonds: 0, frame: '', badge: '', badgeUrl: '', imageUrl: '', frameUrl: '', progressColor: '', boxImageUrl: '' });
        ...
        <div className="bg-[#141417] rounded-2xl border border-indigo-500/20 p-6 space-y-4">
          ...
          <div className="grid grid-cols-4 gap-4">
            <ImageUpload
              ...
              label="🖼️ صورة المستوى (PNG/WebP/APNG)"
              accept=".png,.webp,.apng,.jpg,.jpeg,.gif"
            />
            <ImageUpload
              ...
              label="📺 إطار المستوى (SVGA/PAG/APNG/WebP)"
              accept=".svga,.vap,.pag,.apng,.webp,.png,.mp4"
            />
            <ImageUpload
              ...
              label="🏅 وسام المستوى (SVGA/PNG/WebP)"
              accept=".svga,.vap,.pag,.apng,.webp,.png"
            />
            <ImageUpload
              ...
              label="📦 صندوق المكافأة (PNG/WebP)"
              accept=".png,.webp,.apng,.jpg,.jpeg"
            />
          </div>
          <div className="flex gap-2">
