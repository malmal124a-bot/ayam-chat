...
export default function DataTable<T>({
  columns, data, onEdit, onDelete, actions, searchKeys, loading,
}: DataTableProps<T>) {
        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="border-b border-white/5">
              ...
              {(onEdit || onDelete || actions) && <th className="text-right text-[10px] uppercase tracking-wider text-slate-500 font-bold p-3 w-28">Actions</th>}
            </tr>
          </thead>
          <tbody>
            {loading ? (
