...
class _ApplyAgencyScreenState extends State<ApplyAgencyScreen> {
  ...
  Future<void> _pickImage(bool isFront) async {
    ...
    try {
      ...
      setState(() {
        if (isFront) _frontImageUrl = url;
        else _backImageUrl = url;
      });
    } catch (e) {
        ...
        builder: (context) => AlertDialog(
          ...
          actions: [
            TextButton(
              ...
              child: Text(tr('ok'), style: TextStyle(color: AppTheme.royalGold)),
            ),
          ],
        ),
      );
  ...
  Widget _buildStep3() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        Text('المبلغ المطلوب: \$${_selectedTier}', style: TextStyle(color: AppTheme.royalGold, fontSize: 16, fontWeight: FontWeight.bold)),
        const SizedBox(height: 25),
        ...
        child: Row(
          ...
          children: [
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('باقة $amount\$', style: TextStyle(color: isSelected ? AppTheme.royalGold : Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
