...
class AccountSecurityScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('account_security'.tr(), style: TextStyle(color: AppTheme.darkBrown, fontWeight: FontWeight.bold)),
    ...
    return Material(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: AppTheme.darkBrown.withOpacity(0.1)),
        ),
        child: SwitchListTile(
          contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
          title: Text(title, style: TextStyle(color: AppTheme.darkBrown, fontWeight: FontWeight.bold)),
          subtitle: Text(subtitle, style: TextStyle(color: AppTheme.darkBrown.withOpacity(0.5), fontSize: 12)),
          value: value,
          onChanged: onChanged,
