...
class AgencyDetailsScreen extends StatelessWidget {
                ...
                children: [
                  Container(
                    ...
                    child: CircleAvatar(
                      ...
                      child: Text(
                        agency.name[0],
                        style: TextStyle(fontSize: 40, color: AppTheme.royalGold, fontWeight: FontWeight.bold),
                      ),
                    ),
                  ),
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(color: AppTheme.royalGold, fontWeight: FontWeight.bold, fontSize: 13),
                    ),
                  ),
                ],
              ),
  ...
  Widget _buildSectionTitle(String title) {
    return Text(
      title,
      style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900, color: AppTheme.royalGold),
    );
  }
}
