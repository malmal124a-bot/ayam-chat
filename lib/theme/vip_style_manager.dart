  ...
  static VIPStyle getStyle(int vipLevel) {
    if (vipLevel <= 0) {
      return VIPStyle(
        ...
        gradient: LinearGradient(colors: [AppTheme.vipGrey, Colors.blueGrey]),
      ...
      return VIPStyle(
        ...
        gradient: LinearGradient(colors: [AppTheme.vipBlue, AppTheme.vipLightBlue]),
      ...
      return VIPStyle(
        ...
        gradient: LinearGradient(colors: [AppTheme.vipPurple, AppTheme.vipDeepPurple]),
      ...
      return VIPStyle(
        ...
        gradient: LinearGradient(colors: [AppTheme.vipAmber, AppTheme.vipOrange]),
      ...
      return VIPStyle(
        ...
        gradient: LinearGradient(colors: [AppTheme.vipRed, AppTheme.vipDeepOrange]),
        textColor: Colors.white,
        hasGlow: true,
      );
    }
