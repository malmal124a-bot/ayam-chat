...
class WalletScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('wallet'.tr(), style: const TextStyle(color: AppTheme.royalGold, fontWeight: FontWeight.bold)),
      ...
      body: Column(
        children: [
              ...
              children: [
                ...
                Column(
                  children: [
                    Row(
                      children: [
                        const Icon(Icons.account_balance_wallet_rounded, color: AppTheme.royalGold, size: 20),
                        const SizedBox(width: 8),
                    ...
                    const SizedBox(height: 8),
                    Text(
                      '${wallet.balance.value.toStringAsFixed(2)}\$',
          ...
          Padding(
            ...
            child: Row(
              children: [
                const Icon(Icons.history, color: AppTheme.royalGold, size: 20),
                const SizedBox(width: 8),
