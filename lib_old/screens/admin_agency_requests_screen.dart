              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      request.agencyName,
                      style: const TextStyle(color: AppTheme.royalGold, fontSize: 18, fontWeight: FontWeight.bold),
                    ),
                    ...
                    Text(tr('id_card_photos'), style: const TextStyle(color: AppTheme.royalGold, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 8),
                    Row(
                      children: [
                        Expanded(
