...
class AboutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('about'.tr(), style: const TextStyle(color: AppTheme.royalGold, fontWeight: FontWeight.bold)),
        ...
        child: Column(
          children: [
            Container(
              ...
              child: const Icon(Icons.chat_bubble_rounded, size: 60, color: AppTheme.royalGold),
            ),
  ...
  Widget _buildLinkTile(BuildContext context, String title, String subtitle, VoidCallback onTap) {
    return Container(
      ...
      child: ListTile(
        ...
        trailing: const Icon(Icons.arrow_forward_ios, color: AppTheme.royalGold, size: 16),
        onTap: onTap,
      ),
    );
  }
