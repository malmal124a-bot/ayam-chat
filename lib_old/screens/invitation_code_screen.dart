...
class _InvitationCodeScreenState extends State<InvitationCodeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('invitation_code'.tr(), style: const TextStyle(color: AppTheme.royalGold)),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          const Icon(Icons.stars_rounded, color: AppTheme.royalGold, size: 28),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(15),
                      borderSide: const BorderSide(color: AppTheme.royalGold, width: 1),
                    ),
                  ),
                ),
  ...
  Widget _buildRewardItem(String text) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Icon(Icons.check_circle_outline, color: AppTheme.royalGold, size: 16),
