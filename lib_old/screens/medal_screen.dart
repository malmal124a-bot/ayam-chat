    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          leading: IconButton(
            icon: const Icon(Icons.arrow_back_ios, color: AppTheme.royalGold, size: 20),
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              const Icon(Icons.stars_rounded, color: AppTheme.royalGold, size: 14),
      ...
      child: AnimatedSwitcher(
        ...
        child: medal != null
            ? Padding(
                ...
                child: Image.asset(medal!.iconPath, fit: BoxFit.contain),
              )
            : Center(
                child: Icon(
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: const BorderSide(color: AppTheme.royalGold, width: 0.5),
        ),
        content: Column(
          ...
          children: [
            ...
            Text(
              medal.name,
              style: const TextStyle(color: AppTheme.royalGold, fontSize: 20, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 10),
            Text(
              medal.description,
