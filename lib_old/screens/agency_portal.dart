...
class _TargetManagementTab extends StatelessWidget {
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    const Text('الرصيد القابل للسحب:', style: TextStyle(color: AppTheme.darkBrown)),
                    Text('${controller.hostCurrentProgress.toInt()} نقطة', 
                        style: const TextStyle(color: AppTheme.royalGold, fontWeight: FontWeight.w900, fontSize: 18)),
                  ],
                ),
  ...
  Widget _buildInfoCard({
    ...
    Color color = AppTheme.royalGold,
  }) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(title, style: const TextStyle(color: AppTheme.darkBrown, fontSize: 15, fontWeight: FontWeight.w900)),
          const SizedBox(height: 20),
          Stack(
            children: [
              Container(
          ...
          Row(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Text('$target $unit', style: const TextStyle(color: AppTheme.darkBrown, fontWeight: FontWeight.w900)),
  ...
  void _showWithdrawDialog(BuildContext context, AgencyController controller) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Text('سحب أرباح الموديفين', style: TextStyle(color: AppTheme.darkBrown, fontWeight: FontWeight.w900)),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('رصيدك الحالي المتاح للفك:', style: TextStyle(color: Colors.grey, fontSize: 12)),
            Text('${controller.hostCurrentProgress.toInt()} نقطة', style: const TextStyle(color: AppTheme.darkBrown, fontWeight: FontWeight.w900)),
            const SizedBox(height: 20),
            TextField(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(18), side: BorderSide(color: Colors.grey.withValues(alpha: 0.1))),
                child: ListTile(
                  ...
                  title: Text(supporter.name, style: const TextStyle(color: AppTheme.darkBrown, fontWeight: FontWeight.bold)),
                  ...
                  trailing: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: [
                      Text('${supporter.amount.toInt()}', style: const TextStyle(color: AppTheme.royalGold, fontWeight: FontWeight.w900, fontSize: 16)),
