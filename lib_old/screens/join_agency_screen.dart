...
class _JoinAgencyScreenState extends State<JoinAgencyScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('الانضمام لوكالة موديفين', style: TextStyle(color: AppTheme.darkBrown, fontWeight: FontWeight.bold)),
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                maxLength: 4,
                style: const TextStyle(color: AppTheme.darkBrown, fontSize: 28, letterSpacing: 10, fontWeight: FontWeight.bold),
                textAlign: TextAlign.center,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            searchedAgency.name,
            style: const TextStyle(color: AppTheme.darkBrown, fontSize: 20, fontWeight: FontWeight.bold),
          ),
          Text(
            'ID: ${searchedAgency.id}',
            style: const TextStyle(color: AppTheme.royalGold, fontSize: 14, fontWeight: FontWeight.bold),
          ),
          const SizedBox(height: 10),
          Text(
