        ...
        return Card(
          ...
          child: ListTile(
            ...
            leading: CircleAvatar(
              ...
              child: Text(member.name[0], style: const TextStyle(color: AppTheme.darkBrown)),
            ),
            title: Text(member.name, style: const TextStyle(color: AppTheme.darkBrown, fontWeight: FontWeight.bold)),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(agency.name, style: const TextStyle(color: AppTheme.darkBrown, fontSize: 22, fontWeight: FontWeight.bold)),
                const SizedBox(height: 4),
                Text('ID: ${agency.id}', style: const TextStyle(color: AppTheme.royalGold, fontSize: 12, fontWeight: FontWeight.bold)),
                const SizedBox(height: 4),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(value, style: const TextStyle(color: AppTheme.darkBrown, fontSize: 18, fontWeight: FontWeight.bold)),
          const SizedBox(height: 4),
  ...
  void _showInviteDialog() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text('invite_member'.tr(), style: const TextStyle(color: AppTheme.darkBrown)),
        content: TextField(
